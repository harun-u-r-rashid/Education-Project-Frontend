                ...
                <div id="nav-container" className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link text-uppercase text-light" to="/login/">
                                    {" "}
                                    sign in  <i class="fa-solid fa-arrow-right-to-bracket"></i>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link text-uppercase text-light" to="/register/">
                                    {" "}
                                   sign up <i class="fa-solid fa-registered"></i>
                                </Link>
                            </li>

                            <li className="nav-item">
                                <Link className="nav-link text-uppercase text-light" to="/logout/">
                                    {" "}
                                   sign out <i class="fa-solid fa-arrow-left"></i>
                                </Link>
                            </li>
                        ...
                        <Link className="btn btn-yellow  text-uppercase" to="/cart/">
