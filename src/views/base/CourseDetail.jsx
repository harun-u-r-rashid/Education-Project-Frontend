...
function CourseDetail() {
    ...
    const fetchCoures = () => {
        useAxios()
            .get(`course/course_details/${param.slug}/`)
            .then((res) => {
                setCourses(res.data);
                setIsLoading();
            });
                                    ...
                                    <div className="col-lg-8">
                                        ...
                                        <ul className="list-inline mb-0">
                                            <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                                                ...
                                                {courses.average_rating}/5
                                            </li>
                                            <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                                                <i className="fas fa-user-graduate text-orange me-2" />
                                                {courses.students?.length} Enrolled
                                            </li>
                                            <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                                            ...
                                            <li className="list-inline-item h6 me-3 mb-1 mb-sm-0">
                                                ...
                                                {moment(courses.date).format("DD MMM, YYYY")}
                                            </li>
                                ...
                                <p className="mb-0">
                                    ...
                                    in.
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {/* Item */}
                                                            {courses?.curriculum?.map((course, index) => (
                                                                <div className="accordion-item mb-3">
                                                                    <h6 className="accordion-header font-base" id="heading-1">
                                                                        <button
                                                                            ...
                                                                            data-bs-target={`#collapse-${course.variant_id}`}
                                                                            aria-expanded="true"
                                                                            aria-controls={`collapse-${course.variant_id}`}
                                                                        >
                                                                            {course.title}
                                                                        ...
                                                                        <div className="accordion-body mt-3">
                                                                            ...
                                                                            {course.variant_id?.map((lecture, index) => (
                                                                                <div className="d-flex justify-content-between align-items-center">
                                                                                    ...
                                                                                    <p className="mb-0">{course.content_duration}</p>
                                                                                </div>
                                                                ...
                                                                <div className="col-md-7">
                                                                    ...
                                                                    <div className="card-body">
                                                                        ...
                                                                        <ul className="list-inline mb-3">
                                                                            ...
                                                                            <li className="list-inline-item me-3">
                                                                                <a href={courses?.teacher?.facebook} className="fs-5 text-facebook">
                                                                                    <i className="fab fa-facebook-square" />
                                                                                </a>
                                                                            </li>
                                                                            <li className="list-inline-item me-3">
                                                                                <a href={courses?.teacher?.linkedin} className="fs-5 text-linkedin">
                                                        ...
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div>
                                                                <div className="d-flex align-items-center">
                                                                    <h3 className="fw-bold mb-0 me-2">${courses?.price}</h3>
                                                                </div>
                                                            </div>
                                    ...
                                    addToCartBtn === "Add to Cart" && (
                                                            ...
                                                            {addToCartBtn === "Added To Cart" && (
                                                                ...
                                                                >
                                                                    <i className='fas fa-check-circle'></i> Add To Cart
                                                                </button>
                                                            )}
